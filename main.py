...
def drawgrid(display):
    global globaloffset
    for i in range(41):
        pygame.draw.line(display, (0, 0, 0), (i*40+globaloffset[0]%40, -80+globaloffset[1]%40), (i*40+globaloffset[0]%40, 880+globaloffset[1]%40))
    for i in range(41):
...
def menu():
    ...
    tk.Label(w, text='ETTT', font=('Impact', 50),fg='black', bg='white', relief='solid').place(x = 200, y = 50, anchor='center')
